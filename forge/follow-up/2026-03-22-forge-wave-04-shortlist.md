...
- it has unresolved Forge value that is not already promoted, normalized, or explicitly closed
...
3. new Discovery-routed Forge candidate
...
- every remaining Forge follow-up is either completed, closed, deferred with re-entry, or follow-up-only with explicit trigger
