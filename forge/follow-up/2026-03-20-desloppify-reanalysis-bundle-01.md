...
Decision state: `accept-for-forge-follow-up`
...
- convert from generic low-priority note to explicit Forge queue placement with acceptance state
...
- one Forge utility contract note that defines:
  - trigger condition
