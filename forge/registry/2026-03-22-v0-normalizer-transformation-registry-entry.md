...
- Target file: forge/core/v0.ts (mirrored to mission-control/src/lib/directive-workspace/v0.ts)
- Primary host checker: `npm run check:directive-transformation-proof`
- Supporting host evidence command: `npm run check:directive-forge-sync`
...
- Proof artifact: `forge/records/2026-03-22-v0-normalizer-transformation-proof.json`
- Promotion artifact: `forge/promotion-records/2026-03-22-v0-normalizer-transformation-promotion-record.md`
