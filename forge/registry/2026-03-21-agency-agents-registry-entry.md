...
- Linked promotion record: `C:\Users\User\.openclaw\workspace\directive-workspace\forge\promotion-records\2026-03-21-agency-agents-promotion-record.md`
...
- Proof path: `C:\Users\User\.openclaw\workspace\directive-workspace\forge\records\2026-03-21-agency-agents-runtime-slice-01-proof.md`
...
- Notes: callable status is bounded to run-scoped sync and rollback against the Forge-owned pack; it does not imply that the upstream persona repo is active runtime truth.
