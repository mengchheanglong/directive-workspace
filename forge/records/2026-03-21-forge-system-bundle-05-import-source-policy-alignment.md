# Forge System Bundle 05: Import-Source Policy Alignment
...
Stop the agent-pack import lane from bypassing Forge source-pack classification policy.
...
- explicit imports were not governed by one canonical Forge-owned rule

## Changes

1. Added canonical Forge policy:
   - `C:\Users\User\.openclaw\workspace\directive-workspace\forge\IMPORT_SOURCE_POLICY.json`
...
Forge import behavior now follows product-owned policy instead of a hidden backend list:
