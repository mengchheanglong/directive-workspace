...
2. Execute next Forge runtime closure for `mini-swe-agent` using existing bounded fallback runbook.
3. Refresh Forge promotion backlog after `mini-swe-agent` decision (promote/defer).
