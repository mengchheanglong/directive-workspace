...
Source follow-up:
- `C:\Users\User\.openclaw\workspace\directive-workspace\forge\follow-up\2026-03-20-promptfoo-runtime-followup.md`
...
- This proves a real Forge runtime evaluation lane exists without treating the full upstream Promptfoo repo as runtime truth.
...
- Primary host checker: `npm run check:directive-promptfoo-forge`
- total tests: `7`
- passed: `6`
- failed: `1`
- score: `0.857`
...
- `npm run check:directive-promptfoo-forge` -> PASS
- `npm run check:ops-stack` -> PASS

## Keep/Discard Decisions

- `keep`: bounded eval harness behavior through Mission Control host runner
- `keep`: explicit result artifacts and guard thresholds as Forge promotion input
...
- remove promptfoo-specific Forge record/proof/promotion/registry artifacts
- remove slice-specific Forge checker wiring
