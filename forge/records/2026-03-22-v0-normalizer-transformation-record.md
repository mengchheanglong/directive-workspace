...
- Component: forge/core/v0.ts normalizer functions (lines 129-254)
...
- Measured baseline:
  ...
  - value: 126
  - measurement method: count lines 129-254 in forge/core/v0.ts
...
- Expected improvement:
  ...
  - measurement method: count lines 129-183 in forge/core/v0.ts after transformation

## Evaluator

- Evaluator type: automated
- Evaluator command (if automated): npm run check:directive-forge-sync && npm run check:directive-transformation-proof && npm run typecheck && npm run build
- Comparison mode: before-after
- Baseline artifact path: forge/records/2026-03-22-v0-normalizer-transformation-proof.json
- Result artifact path: forge/records/2026-03-22-v0-normalizer-transformation-proof.json
...
- Promotion record (if promoted): forge/promotion-records/2026-03-22-v0-normalizer-transformation-promotion-record.md
- Mission alignment (which active-mission objective does this serve): Runtime operationalization — maintainability of Forge core
