...
- source_experiment_design_artifact: `C:\Users\User\.openclaw\workspace\directive-workspace\forge\records\2026-03-23-scientify-literature-monitoring-forge-record.md`
...
- gate_snapshot: `C:\Users\User\.openclaw\workspace\directive-workspace\forge\records\2026-03-23-scientify-literature-monitoring-live-fetch-gate-snapshot.json`
- pass_fail_summary:
...
- rollback_verification: if slice 01 fails, delete slice-specific Forge workflow/proof artifacts and return the candidate to follow-up-only state while keeping Architecture-owned partition logic intact
...
Linked proof record:
- `C:\Users\User\.openclaw\workspace\directive-workspace\forge\records\2026-03-23-scientify-literature-monitoring-runtime-slice-01-proof.md`
