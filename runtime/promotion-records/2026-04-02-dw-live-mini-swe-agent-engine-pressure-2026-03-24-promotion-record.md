...
- Safe output scope: `runtime/promotion-records/`, `runtime/06-promotion-specifications/`, `runtime/01-callable-integrations/`, and `hosts/standalone-host/` read-model truth only
