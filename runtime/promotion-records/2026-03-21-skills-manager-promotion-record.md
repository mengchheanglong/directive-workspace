...
- Source intent artifact: `C:\Users\User\.openclaw\workspace\directive-workspace\runtime\follow-up\2026-03-20-skills-manager-lifecycle-cutover.md`
...
- Rollback plan: restore the pack to `follow_up_only`, remove skills-manager-specific Runtime artifacts and checker wiring, and keep generic import-pack infrastructure only if still useful outside callable skill-lifecycle status.
- Owner: operator
