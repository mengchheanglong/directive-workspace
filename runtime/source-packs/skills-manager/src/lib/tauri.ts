...
export interface ProjectSkill {
  ...
  root_warning_code?: string;
  root_warning_message?: string;
  root_warning_severity?: "info" | "warn" | "error";
  root_warning_selected_root?: string;
  root_warning_alternate_root?: string;
}
