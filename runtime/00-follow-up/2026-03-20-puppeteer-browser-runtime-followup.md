...
This is a clear Runtime-type source:
...
- any retained browser wrapper is re-homed into Runtime/host ownership
...
- Runtime promotion/proof artifacts now exist for the bounded browser lane under `directive-workspace/runtime`
