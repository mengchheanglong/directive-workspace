# OpenMOSS Pressure DW Web-Host Seam-Review Compile Contract 01
...
- Manual seam-open basis:
  - `control/logs/2026-04/2026-04-02-pressure-openmoss-dw-web-host-retarget.md`
- Contract guard:
...
- view route:
  - `/runtime-promotion-readiness/view?path=runtime/05-promotion-readiness/2026-03-26-dw-pressure-openmoss-architecture-loop-2026-03-26-promotion-readiness.md`
- detail payload route:
  - `/api/runtime-promotion-readiness/detail?path=runtime/05-promotion-readiness/2026-03-26-dw-pressure-openmoss-architecture-loop-2026-03-26-promotion-readiness.md`

## Canonical Runtime/Engine truth inputs

- `engine/state/index.ts`
- `engine/workspace-truth.ts`
- the current OpenMOSS pressure promotion-readiness artifact
...
- the OpenMOSS pressure seam-review page rendered by the Directive Workspace web host
...
- Supporting checks:
  - `npm run check:directive-openmoss-pressure-dw-web-host-retarget`
  - `npm run check:runtime-promotion-assistance`
  - focused `npm run report:directive-workspace-state -- runtime/05-promotion-readiness/2026-03-26-dw-pressure-openmoss-architecture-loop-2026-03-26-promotion-readiness.md`
...
- remove this compile-contract artifact and its references from the OpenMOSS pressure promotion-readiness artifact
