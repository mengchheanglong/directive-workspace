...
- a reusable skill-pack seed for callable Runtime surfaces
...
Create a product-owned curated subset under Directive Runtime skill ownership:
- identify which roles are actually useful for Mission Control or general Directive Runtime use
