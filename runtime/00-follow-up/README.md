...
- archive = explicitly archived historical artifacts under `runtime/00-follow-up/archive/`
...
- use `runtime/00-follow-up/archive/` only for verified reference-free historical artifacts

Template:
- `shared/templates/runtime-follow-up-record.md`

Archive:
- `runtime/00-follow-up/archive/`
