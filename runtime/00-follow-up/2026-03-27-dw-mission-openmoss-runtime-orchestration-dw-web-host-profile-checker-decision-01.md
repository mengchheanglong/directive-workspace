...
- Promotion-input package: `runtime/00-follow-up/2026-03-27-dw-mission-openmoss-runtime-orchestration-dw-web-host-promotion-input-package-01.md`
...
Profiles reviewed from `runtime/meta/PROMOTION_PROFILES.json`:
