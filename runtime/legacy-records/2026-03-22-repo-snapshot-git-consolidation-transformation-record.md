...
- Discovery intake path: `discovery/01-intake/2026-03-22-repo-snapshot-git-consolidation-transformation-intake.md`
...
- Baseline artifact path: `runtime/legacy-records/2026-03-22-repo-snapshot-git-consolidation-transformation-proof.json`
- Result artifact path: `runtime/legacy-records/2026-03-22-repo-snapshot-git-consolidation-transformation-proof.json`
...
- Rollback path: `revert collectGitSnapshot in mission-control/src/server/services/workspace-intel-service.ts, remove mission-control/scripts/benchmark-repo-snapshot-git.ts if undesired, and remove the new Discovery / Runtime transformation artifacts`
- Rollback tested: `no`
