...
- Discovery intake path: `discovery/01-intake/2026-03-23-repo-snapshot-internal-cache-transformation-intake.md`
...
- Baseline artifact path: `runtime/legacy-records/2026-03-23-repo-snapshot-internal-cache-transformation-proof.json`
- Result artifact path: `runtime/legacy-records/2026-03-23-repo-snapshot-internal-cache-transformation-proof.json`
...
- Rollback path: `remove the git and static-surface inner caches plus helper exports from mission-control/src/server/services/workspace-intel-service.ts, remove mission-control/scripts/benchmark-repo-snapshot-internal-caches.ts if undesired, and remove the new Discovery / Runtime transformation artifacts`
- Rollback tested: `no`
