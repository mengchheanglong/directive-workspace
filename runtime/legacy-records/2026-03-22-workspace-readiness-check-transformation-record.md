...
- Discovery intake path: `discovery/01-intake/2026-03-22-workspace-readiness-check-transformation-intake.md`
...
- Baseline artifact path: `runtime/legacy-records/2026-03-22-workspace-readiness-check-transformation-proof.json`
- Result artifact path: `runtime/legacy-records/2026-03-22-workspace-readiness-check-transformation-proof.json`
