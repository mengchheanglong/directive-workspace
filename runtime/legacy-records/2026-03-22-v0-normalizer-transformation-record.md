...
- Discovery intake path: discovery/01-intake/2026-03-22-v0-normalizer-transformation-intake.md
...
- Baseline artifact path: runtime/legacy-records/2026-03-22-v0-normalizer-transformation-proof.json
- Result artifact path: runtime/legacy-records/2026-03-22-v0-normalizer-transformation-proof.json
...
- Promotion record (if promoted): runtime/07-promotion-records/2026-03-22-v0-normalizer-transformation-promotion-record.md
