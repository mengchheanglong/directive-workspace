...
- Discovery intake path: `discovery/01-intake/2026-03-22-context-pack-doc-ranking-transformation-intake.md`
...
- Baseline artifact path: `runtime/legacy-records/2026-03-22-context-pack-doc-ranking-transformation-proof.json`
- Result artifact path: `runtime/legacy-records/2026-03-22-context-pack-doc-ranking-transformation-proof.json`
...
- Rollback path: `revert the quest-focus ranking helpers in mission-control/src/server/services/context-pack-service.ts, remove mission-control/scripts/benchmark-context-pack-doc-ranking.ts if undesired, and remove the new Discovery / Runtime transformation artifacts`
- Rollback tested: `no`
