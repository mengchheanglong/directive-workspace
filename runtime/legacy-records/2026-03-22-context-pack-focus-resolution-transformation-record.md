...
- Discovery intake path: `discovery/01-intake/2026-03-22-context-pack-focus-resolution-transformation-intake.md`
...
- Baseline artifact path: `runtime/legacy-records/2026-03-22-context-pack-focus-resolution-transformation-proof.json`
- Result artifact path: `runtime/legacy-records/2026-03-22-context-pack-focus-resolution-transformation-proof.json`
...
- Rollback path: `revert mission-control/src/server/services/context-pack-service.ts and remove the new Discovery / Runtime transformation artifacts`
- Rollback tested: `no`
