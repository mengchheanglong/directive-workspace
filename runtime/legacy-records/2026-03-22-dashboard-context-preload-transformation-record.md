...
- Discovery intake path: `discovery/01-intake/2026-03-22-dashboard-context-preload-transformation-intake.md`
...
- Baseline artifact path: `runtime/legacy-records/2026-03-22-dashboard-context-preload-transformation-proof.json`
- Result artifact path: `runtime/legacy-records/2026-03-22-dashboard-context-preload-transformation-proof.json`
