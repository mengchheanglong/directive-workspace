...
- source_experiment_design_artifact: `runtime/legacy-records/2026-03-23-scientify-literature-monitoring-runtime-record.md`
...
- gate_snapshot: `runtime/legacy-records/2026-03-23-scientify-literature-monitoring-live-fetch-gate-snapshot.json`
- pass_fail_summary:
...
Linked proof record:
- `runtime/legacy-records/2026-03-23-scientify-literature-monitoring-runtime-slice-01-proof.md`
