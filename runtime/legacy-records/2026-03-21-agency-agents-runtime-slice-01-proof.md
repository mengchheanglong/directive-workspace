...
Source follow-up:
- `C:\Users\User\.openclaw\workspace\directive-workspace\runtime\follow-up\2026-03-20-agency-agents-skill-pack-cutover.md`
...
- The existing run-scoped sync lane succeeded against the Runtime-owned `agency-agents` source pack.
- The rollback dry-run succeeded against the captured snapshot set.
- This proves the live host lane can be kept under explicit Runtime accounting without pretending the whole upstream persona library is active runtime truth.
...
- `keep`: curated specialist-role sync and rollback behavior through the Runtime-owned pack
...
- remove agency-agents-specific Runtime proof/promotion/registry artifacts
