...
- Baseline artifact path: `runtime/records/2026-03-22-workspace-readiness-check-transformation-proof.json`
- Result artifact path: `runtime/records/2026-03-22-workspace-readiness-check-transformation-proof.json`
