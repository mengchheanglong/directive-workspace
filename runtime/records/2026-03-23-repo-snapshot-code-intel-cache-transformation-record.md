...
- Baseline artifact path: `runtime/records/2026-03-23-repo-snapshot-code-intel-cache-transformation-proof.json`
- Result artifact path: `runtime/records/2026-03-23-repo-snapshot-code-intel-cache-transformation-proof.json`
