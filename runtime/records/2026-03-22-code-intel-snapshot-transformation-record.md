...
- Discovery intake path: `discovery/intake/2026-03-22-code-intel-snapshot-transformation-intake.md`
...
- Baseline artifact path: `runtime/records/2026-03-22-code-intel-snapshot-transformation-proof.json`
- Result artifact path: `runtime/records/2026-03-22-code-intel-snapshot-transformation-proof.json`
