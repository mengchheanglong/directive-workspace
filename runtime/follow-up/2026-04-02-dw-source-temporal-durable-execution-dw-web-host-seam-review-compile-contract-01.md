# Temporal Durable Execution DW Web-Host Seam-Review Compile Contract 01
...
- Manual seam-open basis:
  - `control/logs/2026-04/2026-04-02-temporal-durable-execution-dw-web-host-retarget.md`
- Contract guard:
...
- view route:
  - `/runtime-promotion-readiness/view?path=runtime/05-promotion-readiness/2026-04-01-dw-source-temporal-durable-execution-2026-04-01-promotion-readiness.md`
- detail payload route:
  - `/api/runtime-promotion-readiness/detail?path=runtime/05-promotion-readiness/2026-04-01-dw-source-temporal-durable-execution-2026-04-01-promotion-readiness.md`

## Canonical Runtime/Engine truth inputs

- `shared/lib/dw-state.ts`
- `engine/workspace-truth.ts`
- the current Temporal durable-execution promotion-readiness artifact
...
- the Temporal durable-execution seam-review page rendered by the Directive Workspace web host
...
- Supporting checks:
  - `npm run check:directive-temporal-durable-execution-dw-web-host-retarget`
  - `npm run check:runtime-promotion-assistance`
  - focused `npm run report:directive-workspace-state -- runtime/05-promotion-readiness/2026-04-01-dw-source-temporal-durable-execution-2026-04-01-promotion-readiness.md`
...
- remove this compile-contract artifact and its references from the Temporal durable-execution promotion-readiness artifact
