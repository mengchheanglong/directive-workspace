# OpenMOSS Pressure DW Web-Host Promotion-Input Package 01
...
- one OpenMOSS pressure seam-review detail surface in the Directive Workspace web host/frontend pair
...
- the OpenMOSS pressure seam-review page in Directive Workspace frontend/web-host
