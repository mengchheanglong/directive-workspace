# mini-swe-agent Runtime Route Proof DW Web-Host Seam-Review Compile Contract 01
...
- Manual seam-open basis:
  - `control/logs/2026-04/2026-04-02-real-mini-swe-agent-runtime-route-dw-web-host-retarget.md`
- Contract guard:
...
- view route:
  - `/runtime-promotion-readiness/view?path=runtime/05-promotion-readiness/2026-03-25-dw-real-mini-swe-agent-runtime-route-v0-2026-03-25-promotion-readiness.md`
- detail payload route:
  - `/api/runtime-promotion-readiness/detail?path=runtime/05-promotion-readiness/2026-03-25-dw-real-mini-swe-agent-runtime-route-v0-2026-03-25-promotion-readiness.md`

## Canonical Runtime/Engine truth inputs

- `shared/lib/dw-state.ts`
- `engine/workspace-truth.ts`
- the current mini-swe route promotion-readiness artifact
...
- the mini-swe route seam-review page rendered by the Directive Workspace web host
...
- Focused profile/checker decision:
  - `npm run check:directive-real-mini-swe-agent-runtime-route-v0-dw-web-host-profile-checker-decision`
...
- Supporting checks:
  - `npm run check:directive-real-mini-swe-agent-runtime-route-dw-web-host-retarget`
  - `npm run check:runtime-promotion-assistance`
  - focused `npm run report:directive-workspace-state -- runtime/05-promotion-readiness/2026-03-25-dw-real-mini-swe-agent-runtime-route-v0-2026-03-25-promotion-readiness.md`
...
- remove this compile-contract artifact and its references from the mini-swe route promotion-readiness artifact
