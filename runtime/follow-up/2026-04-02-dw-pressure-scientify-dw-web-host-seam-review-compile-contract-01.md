# Scientify Pressure DW Web-Host Seam-Review Compile Contract 01
...
- Manual seam-open basis:
  - `control/logs/2026-04/2026-04-02-pressure-scientify-dw-web-host-retarget.md`
- Contract guard:
...
- view route:
  - `/runtime-promotion-readiness/view?path=runtime/05-promotion-readiness/2026-03-25-dw-pressure-scientify-2026-03-25-promotion-readiness.md`
- detail payload route:
  - `/api/runtime-promotion-readiness/detail?path=runtime/05-promotion-readiness/2026-03-25-dw-pressure-scientify-2026-03-25-promotion-readiness.md`

## Canonical Runtime/Engine truth inputs

- `shared/lib/dw-state.ts`
- `engine/workspace-truth.ts`
- the current Scientify pressure promotion-readiness artifact
...
- the Scientify pressure seam-review page rendered by the Directive Workspace web host
...
- remove this compile-contract artifact and its references from the Scientify pressure promotion-readiness artifact
