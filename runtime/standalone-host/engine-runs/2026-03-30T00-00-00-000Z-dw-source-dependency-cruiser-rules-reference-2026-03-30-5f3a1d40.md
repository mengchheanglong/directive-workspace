...
- Current repo truth already points at a canonical facade/private split around `engine/state/index.ts`, which makes this a structural Architecture question.
