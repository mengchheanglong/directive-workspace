...
- Source reference: `forge/core/v0.ts` lines 129-254
...
- Suspected adoption target: `Forge`
- Mission alignment (which active-mission objective does this serve): Runtime operationalization — maintainability of Forge core module
