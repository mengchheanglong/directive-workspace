...
- Why this route: Operator override. Engine scored runtime (19), but the retained value under the active mission is not adopting Inspect AI itself as a reusable host capability. The primary adoption target is evaluator/proof framework patterns â€” tasks, scorers, tool approval, agent evaluation, and sandbox review boundaries â€” which improve Engine evaluation quality and proof design.
...
- Required next artifact: architecture/01-experiments/2026-03-28-dw-source-inspect-ai-2026-03-28-engine-handoff.md
