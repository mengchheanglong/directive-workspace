...
- do not treat the entire upstream Promptfoo feature surface as callable
- do not create arbitrary eval or red-team runtime expansion in this slice
- keep callable status bounded to the existing host eval harness
