# mini-swe-agent Pressure Run DW Web-Host Retarget
...
- revert the dedicated retarget checker and the affected assistance/lifecycle/composition checker expectations
