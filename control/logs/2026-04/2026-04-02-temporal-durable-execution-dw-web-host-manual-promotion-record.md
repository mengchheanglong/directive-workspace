# 2026-04-02 - Temporal Durable Execution DW Web-Host Manual Promotion Record

## Slice

- Candidate: `dw-source-temporal-durable-execution-2026-04-01`
- Owning lane: `Runtime`
- Move: open the first bounded manual Directive Workspace web-host promotion record for the Temporal durable-execution case
