# Forge To Host Handoff

Use this handoff when a Forge candidate is ready to move from product-owned runtime planning into host-owned implementation or activation work.

When to use:
- a Forge runtime slice has finished bounded validation
...
Rules:
- Forge owns the promotion record.
