# Scientify Pressure DW Web-Host Runtime Promotion Guard
...
- applies only to `dw-pressure-scientify-2026-03-25`
...
- the Scientify pressure promotion record exists and links the Runtime record, Runtime proof, Runtime capability boundary, and DW web-host compile-contract artifact truthfully
- canonical state resolves the Scientify pressure current head to that promotion record
...
- no registry entry exists yet for the Scientify pressure candidate
- no host integration, runtime execution, promotion automation claim is introduced

## Required Host Artifacts

- current Scientify pressure promotion-readiness artifact
- current Scientify pressure promotion specification
- current Scientify pressure promotion record
- current Scientify pressure DW web-host seam-review compile-contract artifact
- `shared/contracts/runtime-to-host.md`

## Required Host Commands

- `npm run check:directive-pressure-scientify-dw-web-host-runtime-promotion`
...
- promotion record keeps:
  ...
  - compile contract bounded to the existing Scientify pressure DW web-host seam-review compile-contract artifact
  - rollback explicit
  - validation bounded to local/manual proof only

## Decision Rules

1. This guard validates one manual Scientify pressure promotion record only.
