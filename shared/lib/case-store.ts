...
import type { DirectiveMirroredNoteArchitectureCloseoutProjectionInput } from "./architecture-note-closeout-projections.ts";
import type { DirectiveMirroredDiscoveryFrontDoorProjectionInput } from "./discovery-front-door-projections.ts";
import type { DirectiveMirroredRuntimeFollowUpOpenProjectionInput } from "./runtime-follow-up-projections.ts";
import type { DirectiveMirroredRuntimeProofOpenProjectionInput } from "./runtime-proof-open-projections.ts";
import type { DirectiveMirroredRuntimeCapabilityBoundaryOpenProjectionInput } from "./runtime-capability-boundary-projections.ts";
import type { DirectiveMirroredRuntimePromotionReadinessOpenProjectionInput } from "./runtime-promotion-readiness-projections.ts";
...
export function writeDirectiveMirroredDiscoveryCaseRecord(input: {
  ...
  writeJsonNoBom(caseRecordPath, input.record);
  return {
    caseRecordPath,
    record: input.record,
  };
