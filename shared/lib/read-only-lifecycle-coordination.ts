...
import { buildDirectiveRuntimePromotionAssistanceReport } from "./runtime-promotion-assistance.ts";
...
function readQueueEntries(directiveRoot: string): QueueEntry[] {
...
function isLiveCase(entry: QueueEntry, currentStage: string | null) {
