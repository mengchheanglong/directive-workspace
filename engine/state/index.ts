...
} from "../../architecture/lib/architecture-deep-tail-linkage-index.ts";
import {
...
import type { ArchitectureDeepTailStageId } from "../../architecture/lib/architecture-deep-tail-stage-map.ts";
