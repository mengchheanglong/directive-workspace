...
const CHECKER_ID = "directive_openmoss_pressure_dw_web_host_promotion_input_package";
...
function main() {
  ...
  assert.ok(focus?.ok, "openmoss_pressure_dw_web_host_input_package_focus_should_resolve");
