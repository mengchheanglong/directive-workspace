...
const CHECKER_ID = "directive_temporal_durable_execution_dw_web_host_seam_review_compile_contract";
...
function main() {
  ...
  assert.ok(focus?.ok, "temporal_durable_execution_dw_web_host_compile_contract_focus_should_resolve");
  ...
  assertIncludes(readinessContent, COMPILE_CONTRACT_PATH, "readiness_compile_contract_path");
  assertIncludes(
    readinessContent,
  ...
  assertIncludes(compileContractContent, "runtime execution output", "compile_contract_non_authorization_execution");
