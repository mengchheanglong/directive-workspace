...
const CHECKER_ID = "directive_pressure_scientify_dw_web_host_promotion_input_package";
...
function main() {
  ...
  assert.ok(focus?.ok, "scientify_pressure_dw_web_host_input_package_focus_should_resolve");
