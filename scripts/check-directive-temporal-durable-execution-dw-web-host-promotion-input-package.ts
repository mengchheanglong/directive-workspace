...
const CHECKER_ID = "directive_temporal_durable_execution_dw_web_host_promotion_input_package";
...
function main() {
  ...
  assert.ok(focus?.ok, "temporal_durable_execution_dw_web_host_input_package_focus_should_resolve");
