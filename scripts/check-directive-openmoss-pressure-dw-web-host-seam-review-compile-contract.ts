...
const CHECKER_ID = "directive_openmoss_pressure_dw_web_host_seam_review_compile_contract";
...
function main() {
  ...
  assert.ok(focus?.ok, "openmoss_pressure_dw_web_host_compile_contract_focus_should_resolve");
