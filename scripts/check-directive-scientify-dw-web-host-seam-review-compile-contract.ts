...
const CHECKER_ID = "directive_scientify_dw_web_host_seam_review_compile_contract";
...
function main() {
  ...
  assert.ok(focus?.ok, "scientify_dw_web_host_compile_contract_focus_should_resolve");
