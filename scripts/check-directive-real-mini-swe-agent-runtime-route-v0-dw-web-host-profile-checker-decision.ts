...
const CHECKER_ID = "directive_real_mini_swe_agent_runtime_route_v0_dw_web_host_profile_checker_decision";
...
function main() {
  ...
  assertIncludes(decisionContent, "Decision status: `bounded_dw_web_host_profile_selected`", "decision_status");
