...
- **Transition rules**: experimentâ†’adopted, experimentâ†’deferred, experimentâ†’reference-pattern, reference-patternâ†’adopted (promotion), reference-patternâ†’retired, adoptedâ†’Runtime handoff
...
Created `architecture/01-experiments/2026-03-22-architecture-corpus-normalization.md` â€” the classified inventory of the Architecture corpus. Revision 2 corrects the initial baseline. Contains:
...
| Architecture Corpus Normalization | experiment/audit record | `architecture/01-experiments/2026-03-22-architecture-corpus-normalization.md` |
| This adopted record | adopted record | `architecture/02-adopted/2026-03-22-architecture-corpus-normalization-adopted.md` |
...
| `architecture/02-adopted/2026-03-19-gpt-researcher-*` | Added normalization annotation (structural, strong adaptation) |
| `architecture/02-adopted/2026-03-21-impeccable-*` | Added normalization annotation (meta, evaluation_quality, retroactive self-improvement evidence) |
| `architecture/02-adopted/2026-03-21-hermes-*` | Added normalization annotation (structural, strong adaptation) |
| `architecture/02-adopted/2026-03-19-adopted-candidates-architecture-recheck` | Added normalization annotation (meta, routing_quality, retroactive self-improvement evidence) |
| `architecture/05-reference-patterns/2026-03-20-stage-evidence-citation-handoff-contract` | Retired â€” value fully absorbed by shared schemas |
...
- Delete `architecture/01-experiments/2026-03-22-architecture-corpus-normalization.md`
