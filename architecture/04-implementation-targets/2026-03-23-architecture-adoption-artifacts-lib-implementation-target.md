...
- Paired adoption decision artifact: `architecture/03-adopted/2026-03-23-architecture-adoption-artifacts-lib-adoption-decision.json`
...
- Adopted artifact: `architecture/03-adopted/2026-03-23-architecture-adoption-artifacts-lib-adopted.md`
- Adoption decision artifact: `architecture/03-adopted/2026-03-23-architecture-adoption-artifacts-lib-adoption-decision.json`
- Source bounded result artifact: not retained in this legacy adopted slice.
