...
- Source adoption artifact: `architecture/03-adopted/2026-03-27-dw-pressure-engine-queue-lifecycle-status-hardening-2026-03-27-adopted-planned-next.md`
- Paired adoption decision artifact: `architecture/03-adopted/2026-03-27-dw-pressure-engine-queue-lifecycle-status-hardening-2026-03-27-adopted-planned-next-adoption-decision.json`
- Source bounded result artifact: `architecture/02-experiments/2026-03-27-dw-pressure-engine-queue-lifecycle-status-hardening-2026-03-27-bounded-result.md`
