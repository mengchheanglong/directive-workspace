...
- Source artifact path retained: `architecture/03-adopted/2026-03-28-dw-pressure-engine-legacy-runtime-slice-execution-focus-compat-2026-03-28-adopted-planned-next.md`
...
- `report:directive-workspace-state` now resolves representative historical `runtime/records/*-runtime-slice-01-execution.md` artifacts as clean read-only Runtime history.
