...
- Analysis record ref: `architecture/01-experiments/2026-03-23-arscontexta-phase-isolated-processing-source-analysis.md`
...
- Raw form summary: arscontextaâ€™s four-phase processing guidance isolates processing phases, prefers fresh context per phase, and passes state through files rather than through chat continuity.
...
- Original vs adapted delta: arscontextaâ€™s broad â€œcapture/process/connect/verifyâ€ vault philosophy becomes a Directive-specific rule for when to isolate phases, how to order them, and what packet fields must exist between them.

### Mechanism: phase-handoff-packet

- Adaptation required: `yes`
- Adaptation description: turn arscontextaâ€™s implicit file-based state transfer into a reusable Directive template for bounded phase handoff.
- Adaptation actions:
  - terminology alignment
  - structural reshape
...
- Improvement description: make the execution discipline explicit for Directive Workspaceâ€™s weak point: source-driven adaptation quality.
- Improvement rationale: the source does not target Directiveâ€™s source-adaptation chain directly; the improved form does.
