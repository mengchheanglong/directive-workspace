...
- Source reference: `runtime/legacy-handoff/2026-03-22-autoresearch-architecture-to-runtime-handoff.md`
...
- Support the two legacy `runtime/legacy-handoff/*.md` artifacts only.
