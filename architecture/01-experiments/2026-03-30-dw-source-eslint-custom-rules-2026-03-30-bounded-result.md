# ESLint Custom Rule System Bounded Architecture Result
...
- Closeout approval: reviewed by codex-mcp-preflight-pass from bounded start `architecture/01-experiments/2026-03-30-dw-source-eslint-custom-rules-2026-03-30-bounded-start.md`
...
- Result summary: ESLint is the first outside source in the current pressure loop that isolates a concrete Architecture artifact instead of only general workflow guidance. The bounded retained slice is one Directive-owned checker-definition schema pattern for repo validation scripts: each checker should declare rule identity, purpose, option-shape validation, severity posture, suppression boundary, evidence contract, and self-test entrypoint. Out of scope: ESLint AST visitor runtime, plugin packaging, JavaScript-specific execution, editor integration, bulk-suppression storage mechanics, and any host/runtime execution seam. The next truthful move is one implementation-target slice that materializes this schema against a very small subset of existing check scripts.
- Evidence path:
- Bounded start: `architecture/01-experiments/2026-03-30-dw-source-eslint-custom-rules-2026-03-30-bounded-start.md`
- Handoff stub: `architecture/01-experiments/2026-03-30-dw-source-eslint-custom-rules-2026-03-30-engine-handoff.md`
...
- Closeout decision artifact: `architecture/01-experiments/2026-03-30-dw-source-eslint-custom-rules-2026-03-30-bounded-result-adoption-decision.json`
...
- Source analysis ref: architecture/01-experiments/2026-03-30-dw-source-eslint-custom-rules-2026-03-30-engine-handoff.md
...
- `architecture/01-experiments/2026-03-30-dw-source-eslint-custom-rules-2026-03-30-engine-handoff.md`
