...
- Source reference: `engine/state/shared.ts`
...
- Primary truth surface: `engine/state/shared.ts`
- Public entrypoint: `engine/state/index.ts`
...
Revert the narrow stale-current-head downgrade in `engine/state/shared.ts`, revert the composition assertions, and delete this DEEP case chain.
