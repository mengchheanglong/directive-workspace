...
- Source reference: `runtime/legacy-records/2026-03-21-promptfoo-runtime-slice-01-proof.md`
- Engine run record: `n/a`
- Engine run report: `n/a`
- Discovery routing record: `n/a`
- Usefulness level: `meta`
- Usefulness rationale: Meta-usefulness: the historical `runtime/legacy-records/*-runtime-slice-01-proof.md` family is still part of product Runtime history, but the canonical resolver cannot inspect those proof artifacts directly yet, which leaves stale `completed_inconsistent` queue rows.
