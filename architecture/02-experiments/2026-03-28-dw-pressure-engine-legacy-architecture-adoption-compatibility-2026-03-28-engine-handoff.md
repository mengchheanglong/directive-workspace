...
- Source reference: `shared/lib/architecture-result-adoption.ts`
- Engine run record: n/a
- Engine run report: n/a
- Discovery routing record: n/a
- Legacy adopted artifact set:
  - `architecture/03-adopted/2026-03-22-openclaw-runtime-verification-freshness-adopted.md`
  - `architecture/03-adopted/2026-03-22-openclaw-maintenance-watchdog-signal-lane-adopted.md`
  - `architecture/03-adopted/2026-03-22-openclaw-discovery-submission-flow-adopted.md`
  - `architecture/03-adopted/2026-03-22-discovery-gap-priority-worklist-adopted.md`
...
Open one bounded DEEP Architecture slice that makes legacy `architecture/03-adopted/*.md` artifacts canonical current heads without requiring modern adoption decision JSON.
...
Revert the legacy adoption fallback in `shared/lib/architecture-result-adoption.ts`, revert the checker coverage, and delete this DEEP case chain.
