...
- Paired adoption decision artifact: `architecture/02-adopted/2026-03-23-architecture-adoption-resolution-lib-adoption-decision.json`
...
- Adopted artifact: `architecture/02-adopted/2026-03-23-architecture-adoption-resolution-lib-adopted.md`
- Adoption decision artifact: `architecture/02-adopted/2026-03-23-architecture-adoption-resolution-lib-adoption-decision.json`
- Source bounded result artifact: not retained in this legacy adopted slice.
