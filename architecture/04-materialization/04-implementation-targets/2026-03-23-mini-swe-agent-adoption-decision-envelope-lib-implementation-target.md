...
- Source adoption artifact: `architecture/02-adopted/2026-03-23-mini-swe-agent-adoption-decision-envelope-lib-adopted.md`
- Paired adoption decision artifact: `architecture/02-adopted/2026-03-23-mini-swe-agent-adoption-decision-envelope-lib-adoption-decision.json`
...
- Source analysis reference: `architecture/01-experiments/2026-03-23-mini-swe-agent-adoption-decision-envelope-source-analysis.md`
- Adaptation decision reference: `architecture/01-experiments/2026-03-23-mini-swe-agent-adoption-decision-envelope-adaptation.md`
...
- Adopted artifact: `architecture/02-adopted/2026-03-23-mini-swe-agent-adoption-decision-envelope-lib-adopted.md`
- Adoption decision artifact: `architecture/02-adopted/2026-03-23-mini-swe-agent-adoption-decision-envelope-lib-adoption-decision.json`
- Source bounded result artifact: not retained in this legacy adopted slice.
