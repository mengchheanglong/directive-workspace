# Architecture Consumption Record: Autoresearch Ship Workflow (2026-04-06)
...
## artifact linkage
- This applied-integration Architecture record is now stored at `architecture/08-consumption-records/2026-03-26-dw-pressure-autoresearch-ship-control-boundary-2026-03-26-consumption.md`.
- If this consumption record later proves inaccurate or premature, resume from `architecture/07-integration-records/2026-03-26-dw-pressure-autoresearch-ship-control-boundary-2026-03-26-integration-record.md` instead of reconstructing the chain by hand.
