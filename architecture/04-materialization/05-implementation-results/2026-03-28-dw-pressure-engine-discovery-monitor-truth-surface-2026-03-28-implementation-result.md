...
- Source adoption artifact: `architecture/02-adopted/2026-03-28-dw-pressure-engine-discovery-monitor-truth-surface-2026-03-28-adopted-planned-next.md`
- Source bounded result artifact: `architecture/01-experiments/2026-03-28-dw-pressure-engine-discovery-monitor-truth-surface-2026-03-28-bounded-result.md`
...
- Added direct `discovery/04-monitor/*.md` resolver support.
