...
- Source artifact path retained: `architecture/02-adopted/2026-03-28-dw-pressure-engine-legacy-runtime-slice-proof-focus-compat-2026-03-28-adopted-planned-next.md`
...
- `report:directive-workspace-state` now resolves representative historical `runtime/legacy-records/*-runtime-slice-01-proof.md` artifacts as clean read-only Runtime history, and the live queue no longer shows `completed_inconsistent` for that proof family.
