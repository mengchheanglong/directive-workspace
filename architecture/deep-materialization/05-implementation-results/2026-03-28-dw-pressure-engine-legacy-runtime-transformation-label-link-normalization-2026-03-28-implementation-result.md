...
- Source adoption artifact: `architecture/03-adopted/2026-03-28-dw-pressure-engine-legacy-runtime-transformation-label-link-normalization-2026-03-28-adopted-planned-next.md`
- Source bounded result artifact: `architecture/02-experiments/2026-03-28-dw-pressure-engine-legacy-runtime-transformation-label-link-normalization-2026-03-28-bounded-result.md`
...
- Source artifact path retained: `architecture/03-adopted/2026-03-28-dw-pressure-engine-legacy-runtime-transformation-label-link-normalization-2026-03-28-adopted-planned-next.md`
...
- `report:directive-workspace-state` now resolves the remaining label-style historical `runtime/records/*-transformation-record.md` artifacts as clean read-only Runtime history instead of broken link states, and the whole-product composition check now fails if that normalization regresses.
